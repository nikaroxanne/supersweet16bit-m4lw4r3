...
;	int 	21
	...
	lea	dx, hook_int			;; address of TSR program passed in ds:dx
	mov	ah, 0x25			;; new IVR (interrupt vector routine) installed
	;mov 	al, 0x28			;; at IVT[0x85] or Interupt 28
	;mov 	al, 0x16			;; at IVT[0x85] or Interupt 16
	mov 	al, 0x21			;; at IVT[0x85] or Interupt 21
	;mov 	al, 0x33			;; at IVT[0x85] or Interupt 33
	int 	21h
	;pop	bp

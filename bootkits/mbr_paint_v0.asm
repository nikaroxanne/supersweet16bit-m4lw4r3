...
;
;	Uses Int 13h call to read MBR of Drive C:, copies the 512B of MBR to
; 	buffer in data segment of program, then rewrites those bytes back to
;	the VGA buffer (with a pretty colour palette, ofc)
;	
